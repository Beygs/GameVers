...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nvar __1 = __webpack_require__(/*! .. */ \"./src/index.ts\");\nvar GameDetailsPage_1 = __webpack_require__(/*! ./components/GameDetailsPage */ \"./src/ts/components/GameDetailsPage.ts\");\nvar Game_1 = __webpack_require__(/*! ./Game */ \"./src/ts/Game.ts\");\nvar PageDetail = function (_a) {\n    var pageArgument = _a.pageArgument, pageContent = _a.pageContent;\n    var preparePage = function () {\n        var game = __1.games.find(function (g) { return g.id === Number(pageArgument); });\n        if (!game) {\n            fetch(\"https://api.rawg.io/api/games/\".concat(pageArgument, \"?key=\").concat(\"de92c7a378e6497c88c0435e934fd4d4\"))\n                .then(function (response) { return response.json(); })\n                .then(function (result) { return displayResult(new Game_1.default(result).getTrailer().getScreenshots()); });\n            return;\n        }\n        displayResult(game);\n        // const cleanedArg = pageArgument.replace(/\\s+/g, \"-\");\n        // fetchList(`https://api.rawg.io/api/games?key=${process.env.RAWG_KEY}&page_size=27`, cleanedArg);\n        // Use Without API request\n        // const data = require(\"../borderlands_api_results.json\");\n        // console.log(data);\n        // displayResults(data.results);\n    };\n    var displayResult = function (game) {\n        var container = document.querySelector(\".page-details\");\n        console.log(game);\n        if (container)\n            container.innerHTML = \"\".concat((0, GameDetailsPage_1.default)(game));\n    };\n    var render = function () {\n        pageContent.innerHTML = \"\\n    <section class=\\\"page-details\\\">\\n      Hey, this is the Details Page of \".concat(pageArgument, \"!\\n    </section>\\n    \");\n        preparePage();\n    };\n    render();\n};\nexports[\"default\"] = PageDetail;\n\n\n//# sourceURL=webpack://gamevers/./src/ts/PageDetail.ts?");
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nvar ActionableDetail = function (name, values) {\n    var formattedValues = values.map(function (value) { return \"<a href=\\\"#\".concat(value.id, \"\\\">\").concat(value.name, \"</a>\"); }).join(\", \");\n    return \"\\n  <div class=\\\"detail\\\">\\n    <p class=\\\"detail__name\\\">\".concat(name, \"</p>\\n    <p class=\\\"detail__values\\\">\").concat(formattedValues, \"</p>\\n  </div>\\n  \");\n};\nexports[\"default\"] = ActionableDetail;\n\n\n//# sourceURL=webpack://gamevers/./src/ts/components/ActionableDetail.ts?");
...
/***/ "./src/ts/components/GameDetailsPage.ts":
/*!**********************************************!*\
  !*** ./src/ts/components/GameDetailsPage.ts ***!
  \**********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
"use strict";
eval("\nvar __spreadArray = (this && this.__spreadArray) || function (to, from, pack) {\n    if (pack || arguments.length === 2) for (var i = 0, l = from.length, ar; i < l; i++) {\n        if (ar || !(i in from)) {\n            if (!ar) ar = Array.prototype.slice.call(from, 0, i);\n            ar[i] = from[i];\n        }\n    }\n    return to.concat(ar || Array.prototype.slice.call(from));\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nvar __1 = __webpack_require__(/*! ../.. */ \"./src/index.ts\");\nvar ActionableDetail_1 = __webpack_require__(/*! ./ActionableDetail */ \"./src/ts/components/ActionableDetail.ts\");\nvar CardGame_1 = __webpack_require__(/*! ./CardGame */ \"./src/ts/components/CardGame.ts\");\nvar GameDetailsDisplay = function (_a) {\n    var id = _a.id, name = _a.name, description = _a.description, released = _a.released, background_image = _a.background_image, website = _a.website, rating = _a.rating, ratings_count = _a.ratings_count, parent_platforms = _a.parent_platforms, stores = _a.stores, developers = _a.developers, genres = _a.genres, tags = _a.tags, publishers = _a.publishers, trailer = _a.trailer, screenshots = _a.screenshots;\n    var formattedStores = stores\n        .map(function (store) { return store.store; })\n        .map(function (store) { return \"<a class=\\\"store\\\" href=\\\"\".concat(store.domain.match(/^http/) ? store.domain : \"http://\" + store.domain, \"\\\">\").concat(store.name, \"</a>\"); })\n        .join(\"\\n\");\n    var formattedScreenshots = \"\";\n    if (screenshots)\n        formattedScreenshots = screenshots.map(function (screenshot) { return \"<img src=\\\"\".concat(screenshot, \"\\\" alt=\\\"Screenshot\\\">\"); }).join(\"\\n\");\n    var formattedTrailer = \"\";\n    if (trailer)\n        formattedTrailer = \"<h1>Trailer</h1><video src=\\\"\".concat(trailer, \"\\\" type=\\\"video/mp4\\\">\");\n    var gamesArr = __spreadArray([], __1.games, true);\n    var resultsContent = gamesArr.filter(function (game) { return game.id !== id; }).map(function (game) { return (0, CardGame_1.default)(game); }).slice(0, 9).join(\"\\n\");\n    return \"\\n  <div class=\\\"header\\\">\\n    <img src=\\\"\".concat(background_image, \"\\\" alt=\\\"illustration\\\">\\n    <a class=\\\"website\\\" href=\\\"\").concat(website, \"\\\" target=\\\"_blank\\\">Check Website</a>\\n  </div>\\n  <div class=\\\"content\\\">\\n    <div class=\\\"content__header\\\">\\n      <h3 class=\\\"title\\\">\").concat(name, \"</h3>\\n      <h4 class=\\\"rating\\\">\").concat(rating, \"/5 - \").concat(ratings_count, \"&nbsp;votes</h4>\\n    </div>\\n    <div class=\\\"description\\\">\\n      \").concat(description, \"\\n    </div>\\n    <div class=\\\"details details-first\\\">\\n      <div class=\\\"detail\\\">\\n        <p class=\\\"detail__name\\\">Release Date</p>\\n        <p class=\\\"detail__values\\\">\").concat(released, \"</p>\\n      </div>\\n      \").concat((0, ActionableDetail_1.default)(\"Developer(s)\", developers), \"\\n      \").concat((0, ActionableDetail_1.default)(\"Platforms\", parent_platforms.map(function (item) { return item.platform; })), \"\\n      \").concat((0, ActionableDetail_1.default)(\"Publisher(s)\", publishers), \"\\n    </div>\\n    <div class=\\\"details details-last\\\">\\n      \").concat((0, ActionableDetail_1.default)(\"Genre(s)\", genres), \"\\n      \").concat((0, ActionableDetail_1.default)(\"Tags\", tags.filter(function (tag) { return tag.language === \"eng\"; })), \"\\n    </div>\\n    <h1>Buy</h1>\\n    \").concat(formattedStores, \"\\n    \").concat(formattedTrailer, \"\\n    <h1>Screenshots</h1>\\n    <div class=\\\"screenshots articles\\\">\\n      \").concat(formattedScreenshots, \"\\n    </div>\\n    <h1>Similar Games</h1>\\n    <div class=\\\"articles\\\">\\n      \").concat(resultsContent, \"\\n    </div>\\n  </div>\\n  \");\n};\nexports[\"default\"] = GameDetailsDisplay;\n\n\n//# sourceURL=webpack://gamevers/./src/ts/components/GameDetailsPage.ts?");
